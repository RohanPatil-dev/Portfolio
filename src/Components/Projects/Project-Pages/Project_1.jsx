...
import { blogify } from "../../../Data/Projects/Project_data"
    ...
    <>
      <div id="carouselExampleIndicators" className="carousel slide w-75 container mt-4" data-ride="carousel">
       ...
       <div className="container mt-5 text-secondary" data-aos="fade-top"> 
           <h5>{blogify.description}</h5>
       </div>

       <ul className="container list mt-5">
            {
              blogify.key_features.map((value,index)=>{
                 return(
                   <>
       ...
       <div className="repo">
           <Link to="https://github.com/RohanPatil-dev/Blogging-Platform-API" target="_blank"><img src="./Images/github-icon.png" height="70px" alt="" /></Link>
